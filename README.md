# Amazon Checker API — official examples | eKYC Pro

This repository documents the eKYC Pro Amazon Checker API integration contract using facts from the expansion manifest.

- Product page: https://ekycpro.com/tools/amazon
...
```bash
curl -X POST "https://api.ekycpro.com/v1/check" -H "X-API-Key: ${EKYCPRO_API_KEY}" -H "Content-Type: application/json" -d '{"service_type":"amazon","identifier":"+14155550100"}'
```
...
| --- | --- | --- | --- | --- | --- |
| `amazon` | Amazon Checker | phone | 1–1 identifier | `id, identifier, registered, billed, cost, cost_usd` | [docs](https://docs.ekycpro.com/amazon-number-checker) |
| `amazon_email` | Amazon Email Checker | email | 1–1 identifier | `id, identifier, registered, billed, cost, cost_usd` | [docs](https://docs.ekycpro.com/amazon-email-checker) |
...
- `amazon`: https://docs.ekycpro.com/amazon-number-checker
- `amazon_email`: https://docs.ekycpro.com/amazon-email-checker
